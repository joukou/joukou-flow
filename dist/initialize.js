 ...
 */
var ApiTransport, SocketTransport, WebSocketServer, fs, https, _;
...
module.exports = function(httpRestifyServer, httpsRestifyServer) {
  var apiTransports, servers, socketTransport, wsServer;
  ...
  wsServer = new WebSocketServer({
    httpServer: _.map(servers, function(server) {
      return server.server;
    }),
    autoAcceptConnections: false
  });
  socketTransport = new SocketTransport(wsServer);
  apiTransports = _.map(servers, function(server) {
